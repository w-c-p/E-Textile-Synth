...
const int MIN_CARRIER_FREQ = 1; //was 1
const int MAX_CARRIER_FREQ = 1000; //10000 Was

const int MIN = 1; //1
const int MAX = 30; //10

const int MIN_2 = 1; //1
const int MAX_2 = 15; //15

// desired intensity max and min, for AutoMap, note they're inverted for reverse dynamics
const int MIN_INTENSITY = 700; //700
const int MAX_INTENSITY = 10; //10

// desired mod speed max and min, for AutoMap, note they're inverted for reverse dynamics
const int MIN_MOD_SPEED = 10000; //10000
const int MAX_MOD_SPEED = 1; //1
